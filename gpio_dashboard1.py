...
def create_DB_Header():
        ...
        tk.Label(root,text = " ",       fg='blue',padx=COL_PAD,width=3).grid(row=0,column=1)
        ...
        tk.Label(root,text = " ",       fg='blue',padx=COL_PAD,width=3).grid(row=0,column=7)
...
def set_widget_vars(pin):
        ...
        vDir.set(DIR_MENU_OPTS[1])              # Set to Output by default
